...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://bold-hub-lab.fun/`;
  const URL_IDENTIFAIRE = `BHyXlzhL`;
  ...
  OneSignal.initialize('f8aba77d-774a-4300-8063-3e8dda23e876');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2026-01-19T08:08:00'); //дата з якої поч працювати webView
